...
stats_list = ['MP_x','3PAr','FTr','ORB%','DRB%','AST%','STL%','BLK%','TOV%','USG%','3P%','FT%','2P%','2P','2PA','3P','3PA','FT','FTA','ORB','DRB','TRB','AST','STL','BLK','TOV','PF','PTS','eFG%','TS%_x','TRB%','ORtg','DRtg','dist','spd','tchs','pass','sast','ftast','dfgm','dfga']

stats = pd.read_csv('../data/final_stats.csv')
